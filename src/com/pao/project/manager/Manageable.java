...
public interface Manageable extends ProductCodes {
    ...
    int getClassMask();
        ...
        // This function removes commas from each string to avoid confusions generated by
    //  the CSV format
    default String removeCommas (String toRemove){
        return toRemove.replace(",","''");
    }

        // This function adds back replaced commas from within the strings red from CSV files
    default String revertCommas (String toRevert) {
        return toRevert.replace("''", ",");
    }
